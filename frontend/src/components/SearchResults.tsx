    ...
    <div>
      {results.by_name.length > 0 && (
        <div style={sectionStyle}>
          <div style={headerStyle}>Por nombre ({results.by_name.length})</div>
      ...
      {results.by_type.length > 0 && (
        <div style={sectionStyle}>
          <div style={headerStyle}>Por tipo ({results.by_type.length})</div>
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
      ...
      {results.by_move.length > 0 && (
        <div style={sectionStyle}>
          <div style={headerStyle}>
            Por movimiento ({results.by_move.length})
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
